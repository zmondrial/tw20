...
consumer_key = "bCUO8vOHW6SZjjiYEJ1R3kBRi"
consumer_secret = "h7Q20RkgkMpA2hxRSvg4FhqTyrkPiYiyfV0oscE6AQFTfh8acp"
access_token = "865538221307973632-yZE0KWHLXYxj0E1U7zzE3HK0qfydSOL"
access_token_secret = "Eo3yhXn4TZ3WduGzfSE15aQmLyVG1CDKB1QAhVsgDBcne"
...
if __name__ == '__main__':
    ...
    tags = ["wiebes", "hoekstra", "koolmees", "corona", "coronavirus", "coronanederland", "covid-19", "covid19", "corona-virus", "lockdownnl", "coronapocalypse", "covid19nl", "coronavirusnl", "blijfthuis", "zorg", "bruins"]
    stream.filter(track=tags, languages=["nl"])
