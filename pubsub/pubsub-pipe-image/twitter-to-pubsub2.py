...
consumer_key = os.environ['CONSUMERKEY2']
consumer_secret = os.environ['CONSUMERSECRET2']
access_token = os.environ['ACCESSTOKEN2']
access_token_secret = os.environ['ACCESSTOKENSEC2']

PUBSUB_TOPIC = os.environ['PUBSUB_TOPIC2']
NUM_RETRIES = 3
